...
describe('by', () => {
  ([undefined, Segmentation.CHARS, Segmentation.WORDS] as any[]).forEach(by =>
    describe(formatBy(by), () => {
      ...
      it('treats emojis (with and without ZWJ sequences) as separate words', () =>
        test(
          'text 👨‍👩‍👧‍👦⭐️',
          { by },
      ...
      it('supports script-continuous languages', () =>
        test(
          '吾輩は猫である。名前はたぬき。',
          { by, locale: 'ja' },
          by === Segmentation.WORDS ? (
...
describe('charProps', () => {
  it('works', () => {
    ...
    test(
      { by: Segmentation.CHARS, charProps },
      <>
        <span>
    ...
    test(
      { by: Segmentation.WORDS, charProps },
      <>
        <span>text1</span>
        <span data-char={COLLAPSED_WHITESPACE}>{COLLAPSED_WHITESPACE}</span>
        <span>text2</span>
  ...
  it('supports an undefined return value', () => {
    ...
    test({ by: Segmentation.CHARS, charProps }, MULTIPLE_WORDS_RESULT_CHARS);
    test({ by: Segmentation.WORDS, charProps }, MULTIPLE_WORDS_RESULT_WORDS);
  });
});
...
describe('content', () => {
  ...
  it('supports an undefined return value', () => {
    test(
      { by: Segmentation.CHARS, content: () => undefined },
      <>
        <span>
          <span></span>
          <span></span>
    ...
    test(
      { by: Segmentation.WORDS, content: () => undefined },
      <>
        <span></span>
        <span></span>
        <span></span>
...
describe('omitWhitespaceElements', () => {
  it('works', () => {
    test(
      { by: Segmentation.CHARS, omitWhitespaceElements: true },
      <>
        <span>
          <span>t</span>
          <span>e</span>
    ...
    test(
      { by: Segmentation.WORDS, omitWhitespaceElements: true },
      <>
        <span>text1</span>
        {COLLAPSED_WHITESPACE}
        <span>text2</span>
...
describe('wordProps', () => {
  it('works', () => {
    ...
    test(
      { by: Segmentation.CHARS, wordProps },
      <>
    ...
    test(
      { by: Segmentation.WORDS, wordProps },
      <>
        <span data-word="text1" data-word-index="0">
          text1
        </span>
  ...
  it('supports an undefined return value', () => {
    ...
    test({ by: Segmentation.CHARS, wordProps }, MULTIPLE_WORDS_RESULT_CHARS);
    test({ by: Segmentation.WORDS, wordProps }, MULTIPLE_WORDS_RESULT_WORDS);
  });
});
