...
// Ugh
let CHARS: typeof import('./').CHARS;
let WORDS: typeof import('./').WORDS;
let SplittingWithMeta: typeof import('./').SplittingWithMeta;
...
beforeEach(async () => {
  ...
  ({ CHARS, WORDS, SplittingWithMeta } = await import('./'));
